    ...
    <ul className="text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
      <li>
        <div onClick={() => handleClick("font-serif")} className="flex items-center cursor-pointer p-2">
            <input defaultChecked={fontType === "font-serif" ? true : false} id="default-radio-1" type="radio" value="" name="default-radio" className="cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"></input>
      ...
      <li>
        <div onClick={() => handleClick("font-sans")} className="flex items-center cursor-pointer p-2">
            <input defaultChecked={fontType === "font-sans" ? true : false} id="default-radio-2" type="radio" value="" name="default-radio" className="cursor-pointer w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"></input>
